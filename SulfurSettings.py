...
btn_specs = {
    "debug":  ("DATA/settings/images/ex_dbg_button.jpeg",   (250, 200), 0.15),
...
screen_cfg = {
    ...
    "backup": {
        "path_key":    "backup",
        "screen_btn":  "DATA/settings/images/ex_dbg_screen_backup.jpeg",
        "off_btn":     "DATA/settings/images/ex_dbg_off.jpeg",
        "on_btn":      "DATA/settings/images/ex_dbg_on.jpeg",
        "x_btn":       "DATA/settings/images/ex_dbg_x.jpeg",
        "pos_off":     (425, 200),
    ...
    "user": {
        "path_key":    None,
        "screen_btn":  "DATA/settings/images/ex_user_insight_screen.jpeg",
        "off_btn":     "DATA/settings/images/ex_dbg_off.jpeg",
        "on_btn":      "DATA/settings/images/ex_dbg_on.jpeg",
        "x_btn":       "DATA/settings/images/ex_dbg_x.jpeg",
        "pos_off":     (620, 190),
...
backdrop = pygame.transform.smoothscale(
    pygame.image.load("DATA/settings/images/backdrop.png"),
    (SCREEN[0] + 42, SCREEN[1] + 25)
)
mouse_img = pygame.image.load("DATA/settings/images/mousehitbox.jpeg")
