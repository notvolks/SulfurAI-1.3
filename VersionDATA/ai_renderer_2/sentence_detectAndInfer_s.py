    ...
    if os.access(file_path_path_versionDATA_name_sentences, os.R_OK):
        try:
            ...
            def get_predictions(model, tokenizer, sentences, maxlen):
                ...
                sent_preds, intent_preds = model.predict(padded)
            ...
            acc_sent_global = sent_type_accuracy
            acc_intent_global = intent_accuracy
            avg_accuracy_global = avg_accuracy
            ...
            avg_sent_types = Counter(avg_sent_types).most_common(1)[0][0]
            avg_intent_types = Counter(avg_intent_types).most_common(1)[0][0]
