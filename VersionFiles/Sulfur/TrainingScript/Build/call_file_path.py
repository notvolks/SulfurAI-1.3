...
current_dir = os.path.abspath(os.path.join(
    ...
    os.pardir    # up to SulfurAI-DRL 001-03
))
...
class Call():
    ...
    def grammar(self):
        folder_path_trainingData_grammar = os.path.join(current_dir, 'DATA', 'ai_renderer',"training_data","grammar_func=checkdevice")
    ...
    def arch(self):
        ...
        folder_path_archFullTimeRendererSulfax = os.path.join(current_dir,"VersionDATA","ai_renderer","Sulfax-Architechture","build 001-01")
    ...
    def arch_colon(self):
        ...
        folder_path_colon_symbol = os.path.join(current_dir,"VersionDATA","ai_renderer","Sulfax-Architechture","build 001-01")
    ...
    def training_data(self):
        ...
        folder_path_training_data = os.path.join(current_dir,"DATA","ai_renderer", 'training_data', "data_train")
    ...
    def training_data_sk(self):
        ...
        folder_path_training_data_sk = os.path.join(current_dir, "DATA","ai_renderer", 'training_data', "data_train_sk")
    ...
    def backup_training_data_sk(self):
        global folder_path_training_data_sk, folder_path_training_data_name_sk, file_path_training_data_sk
        folder_path_training_data_sk_backup = os.path.join(current_dir, "DATA","ai_renderer", 'training_data', "BACKUP-DO-NOT-DELETE", "backup_sk")
        # folder_path_training_data_sk = os.path.join(os.path.dirname(os.path.abspath(__file__)),
        # 'DATA/training_data/data_train_sk')
    ...
    def backup_training_data(self):
        global folder_path_training_data_sk, folder_path_training_data_name_sk, file_path_training_data_sk
        folder_path_training_data_backup = os.path.join(current_dir, "DATA","ai_renderer", 'training_data', "BACKUP-DO-NOT-DELETE", "backup_normal")
        # folder_path_training_data_sk = os.path.join(os.path.dirname(os.path.abspath(__file__)),
        # 'DATA/training_data/data_train_sk')
    ...
    def text_data_verify(self):
        folder_path_verify = os.path.join(current_dir, 'VersionDATA', 'verification',"input_text")
    ...
    def input_limit(self):
        global folder_path_training_data_sk, folder_path_training_data_name_sk, file_path_training_data_sk
        folder_path_input_limit = os.path.join(current_dir, "DATA","ai_renderer", "input_limit")
    ...
    def versionDATA_trainingdata_sentences(self):
        folder_path_training_data_versionDATA = os.path.join(current_dir, 'VersionDATA', 'ai_renderer_2',"training_data_sentences")
    ...
    def arch_runner(self):
        folder_path_OuputData_average_device_accuracy = os.path.join(current_dir, 'VersionFiles', 'Sulfur',"ArchitectureBuild")
    ...
    def arch_runner_folder(self):
        folder_path = os.path.join(current_dir, 'VersionFiles', 'Sulfur',"ArchitectureBuild")
        return folder_path
    ...
    def Output_UserInsight(self):
        folder_path_output = os.path.join(current_dir, 'DATA')
    ...
    def training_data_location(self):
        folder_path_OuputData_average_device_accuracy = os.path.join(current_dir, 'VersionDATA', 'ai_renderer',"sentence_location_build","training_data_sentences")
        folder_path = "data.txt"
        file_path = os.path.join(folder_path_OuputData_average_device_accuracy, folder_path)
        return file_path

    def cache_LocalScriptHost(self):
        folder_path_OuputData_average_device_accuracy = os.path.join(current_dir, 'VersionDATA', 'cache')
    ...
    def EXTERNALAPP_dashboard_renderer(self):
        folder_path_OuputData_average_device_accuracy = os.path.join(current_dir, 'SulfurDashboardAssets', 'renderer')
        folder_path = "snippet.html"
        file_path = os.path.join(folder_path_OuputData_average_device_accuracy, folder_path)
        return file_path

    def EXTERNALAPP_dashboard_css(self):
        folder_path_OuputData_average_device_accuracy = os.path.join(current_dir, 'SulfurDashboardAssets', 'styling')
